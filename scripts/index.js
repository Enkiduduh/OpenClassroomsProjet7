...
function searchInRecipes(arrayOfRecipes, input, tagslist) {
  ...
  if (input.length >= 3) {
    ...
    for (i = 0; i < arrayOfRecipes.length; i++) {
      ...
      if (
        arrayOfRecipes[i].name.toLowerCase().includes(lowerInput) ||
        arrayOfRecipes[i].description.toLowerCase().includes(lowerInput) ||
        arrayOfRecipes[i].ingredients.some((ingredient) =>
      ...
      const isMatchIngredient = arrayOfRecipes[i].ingredients.some(
        (ingredient) => ingredient.ingredient.toLowerCase().includes(lowerInput)
      );
      const isMatchAppliance = arrayOfRecipes[i].appliance
        .toLowerCase()
        .includes(lowerInput);
      const isMatchUstensil = arrayOfRecipes[i].ustensils.some((ustensil) =>
...
function searchIngredients(input) {
  ...
  dataSet.ing.forEach((ingredient) => {
    const isMatchIngredientSuggested = ingredient
      .toLowerCase()
      .includes(lowerInput);
...
function searchAppareils(input) {
  ...
  dataSet.app.forEach((appareil) => {
    const isMatchApplianceSuggested = appareil
      .toLowerCase()
      .includes(lowerInput);
...
function searchUstensils(input) {
  ...
  dataSet.ust.forEach((ustensil) => {
    const isMatchUstensilSuggested = ustensil
      .toLowerCase()
      .includes(lowerInput);
...
function initializeFilters() {
  ...
  const suggestedTagsForIng = document.getElementById(
    "filter-ingredients-input"
  );
  ...
  const filterListIngredients = document.querySelector(
    ".filter-list-ingredients"
  );
  const filterHiddenIngredients = document.querySelector(
    ".filter-hidden-ingredients"
  );
  const selectedTagsIngredients = document.querySelector(
    ".selectedTags-ingredients"
  );
  setupFilter(
    filterIngredients,
    ingredientsIcon,
    filterHiddenIngredients,
  ...
  const filterHiddenUstensils = document.querySelector(
    ".filter-hidden-ustensils"
  );
  const selectedTagsUstensils = document.querySelector(
    ".selectedTags-ustensils"
  );
  setupFilter(
    filterUstensils,
    ustensilsIcon,
    filterHiddenUstensils,
    filterListUstensils,
    "ustensils",
    searchUstensils,
    suggestedTagsForUst,
  ...
  const filterHiddenAppareils = document.querySelector(
    ".filter-hidden-appliance"
  );
  const selectedTagsAppareils = document.querySelector(
    ".selectedTags-appliance"
  );
  setupFilter(
    filterAppareils,
    appareilsIcon,
    filterHiddenAppareils,
    filterListAppareils,
    "appliance",
    searchAppareils,
    suggestedTagsForApp,
